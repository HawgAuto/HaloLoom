#!/usr/bin/env python3
"""Fail-closed verifier for the local Codex/AMD HaloLoom candidate."""
...
REQUIRED_IMPORTS = ("hyperloom", "kernelforge", "Magpie", "TraceLens", "geak", "metrix", "ray")
REQUIRED_COMMANDS = (
    "inference_optimizer", "quantization-agent", "kernelforge", "magpie", "metrix",
...
def verify() -> dict[str, object]:
    ...
    return {
        "status": "PASS" if not errors else "FAIL", "target": "gfx1151",
        "hyperloom_version": hyperloom_version, "refs": refs, "imports": imports,
        "commands": commands, "geak_runner": str(runner),
        "intellikit_gfx1151_backend": str(metrix_backend), "errors": errors,
    }
